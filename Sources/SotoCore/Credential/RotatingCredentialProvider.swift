...
public final class RotatingCredentialProvider: CredentialProvider {
    ...
    public init(context: CredentialProviderFactory.InitContext, provider: CredentialProvider, remainingTokenLifetimeForUse: TimeInterval? = nil) {
    ...
    private func refreshCredentials(on eventLoop: EventLoop, context: Context) -> EventLoopFuture<Credential> {
        self.lock.lock()
